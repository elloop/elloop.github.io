...
![cocosbuilder_in_vs_3.9.png](http://7xi3zl.com1.z0.glb.clouddn.com/cocosbuilder_in_vs_3.9.png)
...
![ccb_label.png](http://7xi3zl.com1.z0.glb.clouddn.com/ccb_label.png)

**添加一个MenuItemImage名字叫mBtn, selector名字叫onClick.**：

![ccb_btn.png](http://7xi3zl.com1.z0.glb.clouddn.com/ccb_btn.png)
...
![ccbi_helloworld.png](http://7xi3zl.com1.z0.glb.clouddn.com/ccbi_helloworld.png)
...
![CCBTestPage.gif](http://7xi3zl.com1.z0.glb.clouddn.com/CCBTestPage.gif)
...
public:
    ...
    // CCBSelectorResolver定义的回调函数，用来绑定按钮和Control上的回调函数，由ccbi解析模块里的代码回调到此处，重写此方法，以实现自己的绑定逻辑.
    ...
    // 原来的返回nullptr, 以使解析逻辑走到onResolveCCBCCMenuItemSelectorPassSender.
...
{
    loadFromCcbi("ccbi/baozao.ccbi");       // 调用父类CCBPage的ccbi解析操作
}
