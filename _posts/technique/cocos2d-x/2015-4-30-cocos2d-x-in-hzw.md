...
2. 性能优化
	...
	内存
		...
		cppcheck、instrument、crtDbg.h #define new new( _CLIENT_BLOCK, __FILE__, __LINE__)_CrtSetDbgFlag(_CRTDBG_ALLOC_MEM_DF | _CRTDBG_LEAK_CHECK_DF);
